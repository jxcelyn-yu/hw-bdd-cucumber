...
Scenario: sort movies alphabetically
  ...
  And I should see "Amelie" before "Chocolat" in the movie list
  And I should see "Chocolat" before "The Help" in the movie list
  # your steps here
...
Scenario: sort movies in increasing order of release date
  ...
  And I should see "Raiders of the Lost Ark" before "When Harry Met Sally" in the movie list
